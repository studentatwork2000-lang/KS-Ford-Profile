window.KSFordBooks = {
  ...
  "the-book-of-lodge": {
    ...
    tag: "Series Companion",
    description: "A companion volume for the series, detailing the history and lore.",
    image: "/assets/ks-ford/books/other/the-book-of-lodge-cover.png",
    links: [
      {
        label: "Waterstones",
        url: "https://www.waterstones.com/book/the-book-of-lodge/k-s-ford/9781805175483"
      }
    ]
  },
  "the-woman-who-loves": {
    title: "The Woman Who Loves",
    tag: "Psychological Thriller",
    description: "Betrayal leaves a mark deeper than any physical wound. A story of obsession and the high price of devotion.",
  ...
  "hazel": {
    title: "Hazel",
    tag: "Urban Suspense",
    description: "A chance encounter at a bus stop spirals into a labyrinth of deception. When the past catches up, nowhere is safe.",
    image: "/assets/ks-ford/books/thrillers/hazel-book-scene.png",
    links: []
  }
};
